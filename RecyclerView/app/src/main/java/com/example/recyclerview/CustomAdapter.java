...
public class CustomAdapter extends RecyclerView.Adapter<com.example.recyclerview.CustomAdapter.CustomViewHolder> {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(View view) {
            ...
            this.english = (TextView) view.findViewById(R.id.english_item);
            this.korean = (TextView) view.findViewById(R.id.korean_item);
        }
    }
